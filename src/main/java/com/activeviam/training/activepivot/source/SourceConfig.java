package com.activeviam.training.activepivot.source;
...
public class SourceConfig {
    ...
    public CSVSource<Path> csvSource() {
        ...
        final var instrumentColumns = schemaMetadata.getFields(StoreAndFieldConstants.INSTRUMENT_STORE_NAME);
        final var instrumentTopic = csvTopicFactory.createTopic(StoreAndFieldConstants.INSTRUMENT_STORE_NAME, env.getProperty("file.instrument"),
                createParserConfig(instrumentColumns.size(), instrumentColumns));
        csvSource.addTopic(tradesTopic);
        csvSource.addTopic(instrumentTopic);
    ...
    public Void initialLoad() {
        ...
        csvChannels.add(csvChannelFactory().createChannel(StoreAndFieldConstants.INSTRUMENT_STORE_NAME, StoreAndFieldConstants.INSTRUMENT_STORE_NAME));
