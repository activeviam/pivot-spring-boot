...
import static com.activeviam.apps.pivot.config.PivotManagerConfig.INT_FORMATTER;
import static com.activeviam.apps.pivot.config.PivotManagerConfig.NATIVE_MEASURES;
