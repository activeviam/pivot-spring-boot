 ...
 */
@Component
public class TradesSchemaSelectionConfigurer implements ISchemaSelectionConfigurer {

    private final Collection<ICubeConfigurer> cubeConfigurers;

    public TradesSchemaSelectionConfigurer(@OnSchema(TRADES_SCHEMA_NAME) Collection<ICubeConfigurer> cubeConfigurers) {
        this.cubeConfigurers = cubeConfigurers;
    }

    @Override
    public String schemaName() {
        return TRADES_SCHEMA_NAME;
    }
