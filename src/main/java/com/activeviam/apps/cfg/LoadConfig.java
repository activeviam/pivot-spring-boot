...
public class LoadConfig {
    ...
    private final boolean postponeInitialLoad;
    ...
    public LoadConfig(
            ...
            @Value("${initial-load.postpone:false}") boolean postponeInitialLoad) {
        this.datastore = datastore;
        this.csvSource = csvSource;
        this.csvChannelFactory = csvChannelFactory;
        this.schemaPrinter = schemaPrinter;
        this.postponeInitialLoad = postponeInitialLoad;
    }

    @PostConstruct
    void onLoadConfigReady() throws Exception {
        log.info("onLoadConfigReady triggered");
        if (!postponeInitialLoad) {
            initialLoad();
        }
    }
